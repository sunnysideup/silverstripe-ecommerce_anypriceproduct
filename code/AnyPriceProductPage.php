...
class AnyPriceProductPage extends Product {
	...
	private static $singular_name = "Any Price Product";
		function i18n_singular_name() { return _t("AnyPriceProductPage.ANY_PRICE_PRODUCT", "Any Price Product");}

	private static $plural_name = "Any Price Products";
		function i18n_plural_name() { return _t("AnyPriceProductPage.ANY_PRICE_PRODUCTS", "Any Price Products");}
